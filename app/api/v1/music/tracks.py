...
@router.post(
    ...
    description=(
        ...
        "soprano, falsetto, whisper, chest, balanced. Регистровые значения "
        "(bass…soprano, falsetto, chest) сдвигают высоту "
        "клонированного голоса на стадии `vocal_tts`; "
        "все девять дополнительно уходят "
        "вокальным хинтом в промпт music-модели.\n"
